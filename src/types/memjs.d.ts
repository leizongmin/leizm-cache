...
declare module "memjs" {
  ...
  export class Client {
     ...
     * @param callback
     */
    get(key: string, callback: (err?: Error | null, value?: Buffer, flags?: Buffer) => void): void;
    ...
    increment(
      ...
      callback: (err?: Error | null, success?: boolean, value?: number) => void,
    ): void;
     ...
     * @param callback
     */
    append(key: string, value: string | Buffer, callback: (err?: Error | null, success?: boolean) => void): void;
     ...
     * @param callback
     */
    prepend(key: string, value: string | Buffer, callback: (err?: Error | null, success?: boolean) => void): void;
     ...
     * @param callback
     */
    touch(key: string, expires: number, callback: (err?: Error | null, success?: boolean) => void): void;
    ...
    statsWithKey(
      key: string,
      callback: (err?: Error | null, server?: string, stats?: Record<string, string>) => void,
    ): void;
     ...
     * @param retries
     */
    perform(key: string, request: Buffer, seq: number, callback: () => void, retries: number): void;
  }
}
